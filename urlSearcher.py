...
if 'http' not in initial_url: 
    print("No 'http:' I will assume the url as ", 'http://'+initial_url)
...
print ("\nThere were found", len(list_of_reachable_url), " internal urls within the initial url")
...
print ('\nTry to retrieve the object _id',newDocument['_id'])
